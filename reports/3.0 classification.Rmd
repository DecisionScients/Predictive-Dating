...
# Classification
Classification problems occur as much, if not more often, than regression problems. In this section, we revisit the classification problem focusing on **binary classification**, where the goal is to predict a binary-valued target.  Examples of binary classification problems include:  
